          ...
          <TabsContent value="company" className="space-y-6">
                    ...
                    <div className="flex items-center justify-between p-4 border rounded-lg bg-gradient-to-r from-blue-50 to-purple-50">
                      <div>
                        <div className="flex items-center gap-2 mb-1">
                          ...
                          <span className="font-semibold">Plano Empresarial</span>
                        </div>
                        <p className="text-sm text-gray-600">R$ 299/mês • Renovação em 15 dias</p>
                        <p className="text-xs text-gray-500">Até 200 usuários • Recursos ilimitados</p>
                      </div>
                    </div>
                    <div className="flex gap-2">
                      <Button variant="outline" className="flex-1">Alterar Plano</Button>
                      <Button className="flex-1">Gerenciar Faturamento</Button>
                    </div>
                  </div>
                </CardContent>
              </Card>
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <div className="w-full bg-gray-200 rounded-full h-2">
                        <div className="bg-blue-600 h-2 rounded-full" style={{ width: '33.5%' }}></div>
                      </div>
                    </div>
                    <div>
                      <div className="flex justify-between text-sm mb-1">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Gerencie permissões e configurações da equipe</CardDescription>
              </CardHeader>
              <CardContent>
