...
export function EmailCenter() {
  ...
  const emails = [
    {
      ...
      subject: "Dúvida sobre integração Stripe",
      preview: "Olá, estou com problemas para configurar o Stripe em minha conta...",
      timestamp: "14:32",
      isRead: false,
      isStarred: true,
      hasAttachment: false,
    ...
    },
    {
      ...
      preview: "Gostaríamos de discutir uma possível parceria estratégica...",
      timestamp: "13:45",
      isRead: true,
      isStarred: false,
      hasAttachment: true,
      labels: ["Prospect", "Negócios"]
    },
    {
      id: "3",
      from: "Marketing Team",
      email: "marketing@crmpro.com",
      avatar: "/placeholder.svg",
      subject: "Relatório de campanha - Novembro",
      preview: "Segue o relatório completo da campanha de novembro com métricas...",
      timestamp: "12:15",
      isRead: true,
      isStarred: false,
      hasAttachment: true,
      labels: ["Interno", "Relatório"]
    }
  ];
  ...
  const templates = [
    ...
    },
    {
      ...
      subject: "Vamos continuar nossa conversa?",
      category: "Vendas",
      usage: 189,
      openRate: 45.2,
      status: "active"
