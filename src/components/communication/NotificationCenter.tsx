  ...
  const notifications = [
    {
      ...
      description: "Ana Silva: Obrigada pelo suporte rápido!",
      type: "whatsapp",
    ...
    {
      id: "2",
      title: "Email importante recebido",
      description: "Proposta de parceria estratégica - João Santos",
      type: "email",
    ...
    },
    {
      ...
      description: "Maria Costa tentou ligar 2 vezes",
      type: "call",
    ...
    },
    {
      ...
      description: "Demo para cliente - Sala de reunião virtual",
      type: "calendar",
    ...
    },
    {
      ...
      description: "Carlos Oliveira se inscreveu no formulário",
      type: "lead",
    ...
    },
    {
      ...
      description: "Nova versão 2.1.0 instalada com sucesso",
      type: "system",
