...
export const SecuritySettings = () => {
  ...
  const activeSessions = [
    { id: 1, device: "MacBook Pro", location: "São Paulo, BR", ip: "192.168.1.1", lastActive: "Agora", current: true },
    { id: 2, device: "iPhone 14", location: "São Paulo, BR", ip: "192.168.1.2", lastActive: "2 horas atrás", current: false },
    { id: 3, device: "Chrome - Windows", location: "Rio de Janeiro, BR", ip: "201.123.45.67", lastActive: "1 dia atrás", current: false },
  ];

  const securityEvents = [
    { id: 1, event: "Login bem-sucedido", device: "MacBook Pro", time: "Há 10 minutos", type: "success" },
    { id: 2, event: "Senha alterada", device: "MacBook Pro", time: "Ontem às 14:30", type: "warning" },
    { id: 3, event: "Novo dispositivo detectado", device: "iPhone 14", time: "2 dias atrás", type: "info" },
    { id: 4, event: "Tentativa de login bloqueada", device: "Desconhecido", time: "3 dias atrás", type: "danger" },
  ];
